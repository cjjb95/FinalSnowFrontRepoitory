...
namespace GDApp
{
    public class SlipWarning : ZoneObject
    {
        bool once = true;
        public SlipWarning(string id, ActorType actorType, Transform3D transform, EffectParameters effectParameters, Model model) : base(id, actorType, transform, effectParameters, model)
        {
