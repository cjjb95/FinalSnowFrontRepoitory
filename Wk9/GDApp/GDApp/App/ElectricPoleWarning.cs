...
namespace GDApp
{
    public class ElectricPoleWarning : ZoneObject
    {
        bool once = true;
        public ElectricPoleWarning(string id, ActorType actorType, Transform3D transform, EffectParameters effectParameters, Model model) : base(id, actorType, transform, effectParameters, model)
        {
